...
//
//   - script_reload performs the §4.20 line 2604-2615 compatibility-
...
// ReloadReq is the §4.20 line 2624 request payload for
// `_gospore_.script_reload`. Definition is the new (compatibility-
// constrained) Definition to install; the Cell-tier classifier
// inspects oldDef vs Definition against the §4.20 line 2604-2615 table
// before swapping.
//
...
// ReplaceReq is the §4.20 line 2637-2640 request payload for
